...
export const languageAllow = "language.allow";
//
...
//
export const commentBlock = "block";
export const commentLine = "line";
export const commentRaw = "raw";

export const update = "update";
//
export const updateManuel = "manual";
